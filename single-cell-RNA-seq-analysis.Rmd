...
- **Compare gene expression between different cell types within a tissue**

**For each study, state whether it can be investigated with bulk, single-cell, or both, and briefly explain your answer.**
...
```{r, echo=FALSE, fig.alt="UMAP plot of single-cell RNA-seq data from mouse brain samples. https://bioconductor.org/books/3.15/OSCA.basic/dimensionality-reduction.html#non-linear-methods-for-visualization License: [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)"}

knitr::include_graphics("assets/osca-umap-brain-1.png")
```

| Looking at the UMAP plot above, which cell types are most similar to endothelial-mural cells? |
|:-|
| <br> |
...
## Lab Slides {#lab-slides-scrna-seq-analysis}

<!-- (these are just placeholders, copied from a different lab)
...
In this lab, students will learn how to use the [Fly Cell Atlas](https://flycellatlas.org/) to explore single-cell RNA-seq data from fruit flies.
