...
1. Access the C-MOOR Tutorials
    ...
    - If you are using AnVIL, log into AnVIL, navigate to your class Workspace, and start up an RStudio Cloud Environment. See the instruction for starting up LeanrR on AnVIL if you need to jog your memory on how to do this.
