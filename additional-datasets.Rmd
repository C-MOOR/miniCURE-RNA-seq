...
ottrpal::include_slide("https://docs.google.com/presentation/d/1rWH7VTcPV1juH0E9NI-X6evMIKzgn1MQKlf_CRzT73w/edit#slide=id.g3a094ef1421_0_5")
```
...
```{r, echo=FALSE, fig.alt=''}
ottrpal::include_slide("https://docs.google.com/presentation/d/1rWH7VTcPV1juH0E9NI-X6evMIKzgn1MQKlf_CRzT73w/edit#slide=id.g3a094ef1421_0_12")
```
...
```{r, echo=FALSE, fig.alt="UMAP plot of single-cell RNA-seq data from the fruit fly gut. License: [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/)", out.width = '80%'}

knitr::include_graphics("assets/cellxgene_marker_genes.png")
```
