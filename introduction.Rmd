...
ottrpal::include_slide("https://docs.google.com/presentation/d/1rWH7VTcPV1juH0E9NI-X6evMIKzgn1MQKlf_CRzT73w/edit#slide=id.g1f83ffdfb86_0_0")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt=""}
ottrpal::include_slide("https://docs.google.com/presentation/d/1rWH7VTcPV1juH0E9NI-X6evMIKzgn1MQKlf_CRzT73w/edit#slide=id.g1f83ffdfb86_0_19")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt=""}
ottrpal::include_slide("https://docs.google.com/presentation/d/1rWH7VTcPV1juH0E9NI-X6evMIKzgn1MQKlf_CRzT73w/edit#slide=id.g1f83ffdfb86_0_25")
```
...
ottrpal::include_slide("https://docs.google.com/presentation/d/1uwlG7uaTOnItdpd4Ll6nNQiBJKBivsvR-erupicAwJM/edit#slide=id.g3709d9ac459_0_299")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "'Test'"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1uwlG7uaTOnItdpd4Ll6nNQiBJKBivsvR-erupicAwJM/edit#slide=id.g36368ab83bf_0_2")
```
...
1. Open [AnVIL](https://anvil.terra.bio/)
