...
![](https://www.youtube.com/watch?v=5kcAc20Bus8)

1. How is the traditional scientific method different from the scientific process?
1. Describe the key aspects of each of the following elements of the scientific process:
    a. Exploration and Discovery
    a. Testing Ideas
    a. Community Analysis and Feedback
